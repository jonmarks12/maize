...
3. Increment :attr:`maize.__version__`, in namespace repositories you may have to increment the version in documentation (:code:`conf.py`) and the project configuration (:code:`pyproject.toml`)
