...
class TSRefinement(Graph):
    ...
    def build(self) -> None:
        ...
        prfo_sella = flow.add(RunPRFO, name="run_prfo_sella", parameters=dict(method="B3LYP",basis="6-31g(d)"))
        prfo_fsm = flow.add(RunPRFO, name="run_prfo_fsm", parameters=dict(method="B3LYP",basis="6-31g(d)"))
