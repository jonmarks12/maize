...
class Component:
    ...
    _COMPONENT_FIELDS = {"name"}

    tags: ClassVar[set[str]] = set()
    """Tags to identify the component as exposing a particular kind of interface"""

    references: ClassVar[set[Reference]] = set()
    """List of scientific references for the component"""
    ...
    def __init__(
        ...
        if parent is None:
            ...
            # Resource management
            self.cpus = Resources(max_count=cpu_count(), parent=self)
            self.gpus = Resources(max_count=gpu_count(), parent=self)
    ...
    def all_parameters(self) -> dict[str, Input[Any] | Parameter[Any]]:
        ...
        inp_params = {
            ...
            if not inp.is_connected(inp) and not isinstance(inp, MultiInput)
        }
    ...
    def collect_references(self) -> set[Reference]:
        """Provides any scientific references"""
